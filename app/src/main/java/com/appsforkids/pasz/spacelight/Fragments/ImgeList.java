...
public class ImgeList extends Fragment  {
...
//        });
    ...
    public void closeFragment(int position){
        ...
        if(position==-1){
            ...
            ImageView imageView = (ImageView) rv_cards.findViewHolderForAdapterPosition(position).itemView;
            ...
            getParentFragmentManager()
                    ...
                    .replace( R.id.container,  Image.init(link))
                    .commit();
        }
    ...
    private void showImages(){
        rv_cards.setAdapter(new ImageAdapter(imageFiles, height,   new GetActionFromAdapter() {
            ...
            public void usePosition(int position) {
                ...
                //rv_cards.findViewHolderForAdapterPosition();
